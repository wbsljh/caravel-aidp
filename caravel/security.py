...
class CustomSecurityManager(SecurityManager):
    ...
    def get_all_permision_view(self):
        ...
        permissions = [
            ...
            {"viewmenu": "Caravel", "permission": "can_select_star"},
            {"viewmenu": "Caravel", "permission": "can_explore"},
            {"viewmenu": "Caravel", "permission": "can_slice"},
            {"viewmenu": "Caravel", "permission": "can_refresh_datasources"},
            {"viewmenu": "Caravel", "permission": "can_checkbox"},
            {"viewmenu": "Caravel", "permission": "can_activity_per_day"},
            {"viewmenu": "Caravel", "permission": "can_sql"},
            {"viewmenu": "Caravel", "permission": "can_welcome"},
            {"viewmenu": "Caravel", "permission": "can_runsql"},
            {"viewmenu": "Caravel", "permission": "can_dashboard"},
            {"viewmenu": "Caravel", "permission": "can_save_dash"},
            {"viewmenu": "Caravel", "permission": "can_table"},
            {"viewmenu": "Caravel", "permission": "can_testconn"},
